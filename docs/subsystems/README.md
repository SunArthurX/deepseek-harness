...
| [todo.md](todo.md) |
| [crm.md](crm.md) | the investment-advisory CRM capability: `ctx.crm` service surface, suitability and pipeline domain rules, derived time facts, and the durable domain layout | the todo package's whole-list item type, durable event ownership, projection, and open-turn invariant |
