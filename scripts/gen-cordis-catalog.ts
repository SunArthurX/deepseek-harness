...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  AdvisorId: 'advisory-team identity is owned by packages/crm/crm/src/types.ts',
  AdvisorRecord: 'advisor record is owned by packages/crm/crm/src/types.ts',
  BookSnapshot: 'client-book aggregation is owned by packages/crm/crm/src/types.ts',
  ClientBook: '360-degree client view is owned by packages/crm/crm/src/types.ts',
  ClientId: 'client identity is owned by packages/crm/crm/src/types.ts',
  ClientPatch: 'client patch request is owned by packages/crm/crm/src/types.ts',
  ClientRecord: 'client record is owned by packages/crm/crm/src/types.ts',
  ClientSearchQuery: 'client search filters are owned by packages/crm/crm/src/types.ts',
  ClientSummary: 'client search row is owned by packages/crm/crm/src/types.ts',
  ConsultationRecord: 'consultation record is owned by packages/crm/crm/src/types.ts',
  CreateAdvisorRequest: 'advisor registration request is owned by packages/crm/crm/src/index.ts',
  CreateClientRequest: 'client creation request is owned by packages/crm/crm/src/index.ts',
  CreateOpportunityRequest: 'opportunity creation request is owned by packages/crm/crm/src/index.ts',
  CreateTaskRequest: 'task creation request is owned by packages/crm/crm/src/index.ts',
  InteractionListQuery: 'interaction list filters are owned by packages/crm/crm/src/types.ts',
  InteractionRecord: 'interaction record is owned by packages/crm/crm/src/types.ts',
  LogInteractionRequest: 'interaction logging request is owned by packages/crm/crm/src/index.ts',
  MoveOpportunityRequest: 'pipeline move request is owned by packages/crm/crm/src/index.ts',
  OpportunityId: 'opportunity identity is owned by packages/crm/crm/src/types.ts',
  OpportunityListQuery: 'opportunity list filters are owned by packages/crm/crm/src/types.ts',
  OpportunityRecord: 'opportunity record is owned by packages/crm/crm/src/types.ts',
  CreatePlanRequest: 'advisory plan creation request is owned by packages/crm/crm/src/plan-types.ts',
  PlanRecord: 'advisory plan record is owned by packages/crm/crm/src/plan-types.ts',
  PlanStatus: 'advisory plan lifecycle status is owned by packages/crm/crm/src/plan-types.ts',
  PlanReview: 'advisory plan review result is owned by packages/crm/crm/src/plan-types.ts',
  PipelineSnapshot: 'pipeline aggregation is owned by packages/crm/crm/src/types.ts',
  RecordConsultationRequest: 'consultation recording request is owned by packages/crm/crm/src/index.ts',
  SuitabilityAuditEntry: 'audit trail row is owned by packages/crm/crm/src/types.ts',
  TaskId: 'task identity is owned by packages/crm/crm/src/types.ts',
  TaskListQuery: 'task list filters are owned by packages/crm/crm/src/types.ts',
  TaskLoadSnapshot: 'task-load aggregation is owned by packages/crm/crm/src/types.ts',
  TaskRecord: 'task record is owned by packages/crm/crm/src/types.ts',
  z: 'schemastery schema constructor is owned by vendor/schemastery (vendored upstream)',
  ExternalProviderId: 'source-agent identity is owned by packages/import/session-import/src/model.ts',
  SourceListing: 'listing row is owned by packages/import/session-import/src/service.ts',
  ImportSpec: 'resolved import request is owned by packages/import/session-import/src/service.ts',
  ImportOutcome: 'import result contract is owned by packages/import/session-import/src/service.ts',
  SessionImportSourceEventData: 'provenance event payload is owned by packages/import/session-import/src/types.ts',
  SourcePreview: 'preview result contract is owned by packages/import/session-import/src/service.ts',
  SourcePreviewMessage: 'preview row is owned by packages/import/session-import/src/service.ts',
  SyncOutcome: 'sync-all result contract is owned by packages/import/session-import/src/index.ts',
  DemoDataSummary: 'demo-seed summary is owned by packages/crm/crm/src/demo-data.ts',
