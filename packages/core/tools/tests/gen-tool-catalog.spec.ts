...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'cordis_undefine', 'create_goal', 'crm_advisor_list', 'crm_advisor_register',
      'crm_client_create', 'crm_client_get', 'crm_client_search', 'crm_client_update',
      'crm_consultation_record', 'crm_interaction_list', 'crm_interaction_log',
      'crm_opportunity_create', 'crm_opportunity_list', 'crm_opportunity_move', 'crm_report',
      'crm_task_cancel', 'crm_task_complete', 'crm_task_create', 'crm_task_list',
      'crm_task_reschedule', 'edit', 'exit_plan_mode', 'followup_task', 'get_goal', 'glob',
      'grep', 'interrupt_agent', 'interrupt_agent', 'job_kill', 'job_list', 'job_output',
      ...
      'schedule_list', 'send_message', 'send_message', 'session_event_read',
      'session_event_search', 'session_event_trace', 'session_import', 'session_search',
